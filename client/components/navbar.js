      ...
      <nav>
        {isLoggedIn && admin === 'yes' ? (
          <div className="w-100">
            ...
            <Link
              to="/home"
              className="nav-a-text px-4 py-2 m-3 individual-product-color-1"
            >
              Home
            </Link>
            <Link
              to="/products"
              className="nav-a-text px-4 py-2 m-3 individual-product-color-2"
            >
              Products
            </Link>
            <Link
            ...
            <Link className="ml-auto" to="/cart">
              ...
              />
              {cart.products ? (
                <h1 className="nav-cart-quantity">{cart.products.length}</h1>
              ) : (
                <h1 />
              )}
            </Link>
            {/* <Link
              to="/shipping-billing"
              className="nav-a-text px-4 py-2 m-3 individual-product-color-4"
            >
              Shipping
            </Link> */}
            <Link
            ...
            <Link
              to="/all-users"
              className="nav-a-text px-4 py-2 m-3 individual-product-color-3"
            >
              Edit Users
            </Link>
            <Link
